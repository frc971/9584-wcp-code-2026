...
public class Shooter extends SubsystemBase {
    ...
    public Shooter() {
        ...
        configureMotor(leftMotor, InvertedValue.CounterClockwise_Positive, 50, 50);
        configureMotor(middleMotor, InvertedValue.CounterClockwise_Positive, 50, 50);
        configureMotor(rightMotor, InvertedValue.Clockwise_Positive, 50, 50);
